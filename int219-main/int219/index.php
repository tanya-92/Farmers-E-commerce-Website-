            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative group">
                        <button class="text-gray-700 hover:text-primary-600 focus:outline-none p-2">
                            <i class="fas fa-user text-xl"></i>
                        </button>
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg overflow-hidden hidden group-hover:block z-[100]">
                            <?php if ($isLoggedIn): ?>
                                <!-- Logged-in Menu -->
                                <div id="logged-in-menu" class="py-1">
                                    <a href="dashboard.html" class="block w-full px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-all duration-200">Dashboard</a>
                                    <a href="orders.html" class="block w-full px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-all duration-200">My Orders</a>
                                    <a href="logout.php" class="block w-full px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-all duration-200">Logout</a>
                                </div>
                            <?php else: ?>
                                <!-- Logged-out Menu -->
                                <div id="logged-out-menu" class="py-1">
                                    <a href="login.php" class="block w-full px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-all duration-200">Login</a>
                                    <a href="register.php" class="block w-full px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-all duration-200">Register</a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
